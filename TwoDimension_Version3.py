...
# 空间电磁学常数特征化
@ti.kernel
def specialize_constant_rectangle(width: ti.int32, height: ti.int32):  # 矩形特征区
...
def electric_pulse_dot_source(t_step_num: ti.int32):  # 反复调用
    ...
    pulse = ti.cos(omega * real_time / 50)
...
def main():
    ...
    initialize_constant()
    specialize_constant_rectangle(width=50, height=150)
